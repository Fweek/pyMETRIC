...
import scripts.support.gdal_common as gdc
from scripts.support import python_common
...
def raster_swb_func(output_dt, output_osr, output_cs, output_extent,
    ...
    #  days and allowing the scripts to take however many etr and ppt rasters
