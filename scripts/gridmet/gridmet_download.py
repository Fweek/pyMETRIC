...
from scripts.support.python_common import date_range, valid_date, url_download
...
def main(netcdf_ws=os.getcwd(), variables=['all'],
    ...
    Args:
        netcdf_ws (str): root folder of GRIDMET data
        variable (list): GRIDMET variables to download
          ('ppt', 'srad', 'sph', 'tmmn', 'tmmx', 'vs')
...
def arg_parse():
    ...
    Base all default folders from script location
        scripts: ./pyMETRIC/scripts/gridmet
...
if __name__ == '__main__':
    ...
    ncd = os.path.join(home,  'images', 'lolo', 'ncd')
    start = '2015-05-01'
    end = '2017-12-31'
    variables = ['all']

    main(netcdf_ws=ncd, variables=variables,
