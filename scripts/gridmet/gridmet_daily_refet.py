...
import netCDF4
import numpy as np
from gdal import Open as Gopen

from scripts.support import et_common, gdal_common as gdc
...
if __name__ == '__main__':
    ...
    netcdf = os.path.join(lolo, 'gridmet')
    shapefile = os.path.join(lolo, 'extent', 'Missoula_County.shp')

    start = '2015-05-01'
    end = '2017-12-31'

    main(netcdf_ws=netcdf,
         output_ws=netcdf,
         ancillary_ws=netcdf,
         start_date=start, end_date=end,
         extent_path=shapefile,
