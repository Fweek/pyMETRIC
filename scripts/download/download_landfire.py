...
def main(output_folder, version='140', overwrite_flag=False):
    ...
    Args:
        ...
        version (str): LANDFIRE version (105, 110, 120, 130, 140)
    ...
    base_url = 'https://www.landfire.gov/bulk/downloadfile.php?FNAME='
    zip_dict = {
    ...
    if not os.path.isfile(zip_path) or overwrite_flag:
        ...
        url_download(download_url, zip_path, verify=False)
    else:
