...
def main(ini_path, rasters_flag=None, tables_flag=None,
    ...
    Args:
        ...
        rasters_flag (bool): if True, override INI and interpolate rasters
        tables_flag (bool): if True, override INI and interpolate zone tables
        ...
        mp (int): number of cpu cores to use
