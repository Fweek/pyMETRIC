...
# Purpose:      Prepare Landsat/LEDAPS Scenes
# Python:       2.7, 3.5, 3.6
#--------------------------------
...
from support import open_ini, read_param, call_mp
...
def main(ini_path, tile_list=None, blocksize=2048, smooth_flag=True,
    ...
    Args:
        ...
        blocksize (int): Processing blocksize. Default is 2048.
        smooth_flag (bool): if True, dilate/erode image to remove
            fringe/edge pixels. Default is True.
        stats_flag (bool): if True, compute raster statistics.
            Default is True.
        overwrite_flag (bool): if True, overwrite existing files
        mp_procs (int): number of cores to use
        delay (int): max random delay starting function in seconds
        debug_flag (bool): if True, enable debug level logging
        new_window_flag (bool): open each process in new terminal window.
