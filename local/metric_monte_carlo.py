...
from support import open_ini, read_param, call_mp, parse_int_set
...
def main(ini_path, mc_iter_str='', tile_list=None,
    ...
    Args:
        ...
        mc_iter_str (str): MonteCarlo iteration list and/or range
        tile_list (list): list of Landsat path/row (i.e. [p45r43, p45r33])
            This will override the tile list in the INI file
        cold_tgt_pct (float): target percentage of pixels with ETrF greater than cold Kc
        hot_tgt_pct (float): target percentage of pixels with ETrF less than hot Kc
        groupsize (int): Script will try to place calibration point randomly into a
        ...
        no_file_logging (bool): if True, don't write logging to file
