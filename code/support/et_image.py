...
class Image:
    ...
    def __init__(self, image_folder, env=None):
        ...
        self.c1 = et_common.band_dict_to_array(
            self.c1_dict, self.band_sur_dict)
        self.c2 = et_common.band_dict_to_array(
            self.c2_dict, self.band_sur_dict)
        self.c3 = et_common.band_dict_to_array(
            self.c3_dict, self.band_sur_dict)
        self.c4 = et_common.band_dict_to_array(
            self.c4_dict, self.band_sur_dict)
        self.c5 = et_common.band_dict_to_array(
            self.c5_dict, self.band_sur_dict)
        self.cb = et_common.band_dict_to_array(
            self.cb_dict, self.band_sur_dict)
        self.wb = et_common.band_dict_to_array(
            self.wb_dict, self.band_sur_dict)

        # Current values from 2009 Chander paper
    ...
    def convert_solar_time(self, gmt_offset=0):
        ...
        lat_array, lon_array = gdc.raster_ds_lat_lon_func(time_layer)
