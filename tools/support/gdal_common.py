...
def epsg_osr(input_epsg):
    """Return the spatial reference object of an EPSG tools

    Args:
        input_epsg (int): EPSG spatial reference tools as integer
...
def epsg_proj(input_epsg):
    """Return the projecttion WKT of an EPSG tools

    Args:
        input_epsg (int): EPS spatial reference tools as an integer
...
def proj4_osr(input_proj4):
    """Return the spatial reference object of a PROJ4 tools
...
def osr_proj4(input_osr):
    """Return the PROJ4 tools of an osr.SpatialReference
...
def array_to_mem_ds(input_array, output_geo=None, output_proj=None,
    ...
    Main functionality of tools copied from array_to_raster()
