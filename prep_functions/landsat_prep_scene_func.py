...
def hourly_interpolate_func(prev_array, next_array,
    ...
    Args:
        prev_array (str): array at the previous timestep
        next_array (str): array at the next timestep
        image_prev_dt (datetime): datetime of the previous array
        image_next_dt (datetime): datetime of the next array
        image_dt (datetime): datetime to interpolate to
        output_extent: gdal_common.extent to clip to
